...
class AddNewClothesView: UIView {
    ...
    private func setupAddPhotoNextButton() {
        ...
        addPhotoButton.backgroundColor    = Colors.inputBGColor
        addPhotoButton.layer.cornerRadius = Sizes.defaultCornerRadius
        addPhotoButton.titleLabel?.font   = .systemFont(ofSize: Sizes.mediumTextSize, weight: .semibold)
        addPhotoButton.setTitleColor(Colors.textColor, for: .normal)
